  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      ...
      try {
        ...
        const res = await axios.post(`${import.meta.env.VITE_API_URL || ${import.meta.env.VITE_API_URL || '${import.meta.env.VITE_API_URL || `${import.meta.env.VITE_API_URL}`}'}}/api/reservations`, {
